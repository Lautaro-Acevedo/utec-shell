# Basics Shell
* 0-current_working_directory: Imprime el directorio actual.
...
* 5-listfilesdigitonly: Muestra el contenido en formato largo, con archivos ocultos y con IDs de usuario y grupo numéricos.
* 6-firstdirectory: Crea el directorio my_first_directory en /tmp/.
...
* 15-lets_move: Mueve todos los archivos que comienzan con letra mayúscula al directorio /tmp/u.
* 16-clean_emacs: Elimina todos los archivos del directorio actual que terminan en ~.
* 17-tree: Crea la estructura de directorios anidados welcome/to/school.
